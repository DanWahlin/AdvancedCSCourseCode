...
namespace Chapter8.DeserializationCallback
{
    ...
    class IDeserializationCallbackDemo
    {
        ...
        static void Serialize()
        {
            ...
            FileStream fs = new FileStream("../../DeserializationCallback/DataFile.dat", FileMode.Create);
        ...
        static void Deserialize()
        {
            ...
            FileStream fs = new FileStream("../../DeserializationCallback/DataFile.dat", FileMode.Open);
            try
            {
                BinaryFormatter formatter = new BinaryFormatter();
